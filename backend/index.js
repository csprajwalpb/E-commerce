...
//Creating endpoint for Bestsellers(Popular)

app.get('/bestseller', async(req,res)=>{
    let products = await Product.find({id:{$in:[17,1,2,29]}});
    let bestseller = products.slice(0,4);
...
//Creating endpoints for adding products into Cart
...
//Creating endpoints for removing products from Cart
